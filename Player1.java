...
public class Player1 { //program for first player in Battleship
                ...
                if(turn) {
                    ...
                    if(message.length() < 4) {
                        ...
                        if(shipSunk) {
                            ...
                            if(!done)
                                oos.writeObject(pUI.uboard.spaces[x(message)][Integer.parseInt(message.substring(1)) - 1].getShip().name + " sunk.");
                            else {
